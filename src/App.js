...
import './App.css';
import abhiImage from "./harish.jpg"; 
...
function App() {
  ...
  return (
    <div className="App">
      <header>
        <div className="user">
          <img src={abhiImage} alt="harish" />
          <h3 className="name">HARISH</h3>
        </div>
      ...
      <section className="home" id="home">
        <h3>HELLO!!</h3>
        <h1>This is <span>Harish</span></h1>
      </section>
      ...
      <section className="about" id="about">
        ...
        <div className="row">
          <div className="info">
            <h3> <span> Name : </span>HARISH</h3>
            <h3> <span> Qualification : </span> B.Tech(pursuing) </h3>
            <h3> <span> Address</span> KURNOOL</h3>
            <h3> <span> Strengths : </span> Dedication,SmartWork </h3>
            <h3> <span> Hobbies: </span> travelling,Workouts </h3>
            <h3> <span> Language : </span> Telugu, Hindi, English, Marathi </h3>
          </div>
        </div>
      </section>
      ...
      <section className="contact" id="contact">
        ...
        <div className="row">
          <div className="content">
            ...
            <div className="info">
              <h3> <i className="fas fa-envelope"></i> harish.21bce9556@vitapstudent.ac.in</h3>
              <h3> <i className="fas fa-phone"></i> 8331024194 </h3>
              <h3> <i className="fas fa-map-marker-alt"></i> KURNOOL</h3>
            </div>
          </div>
        </div>
      </section>
